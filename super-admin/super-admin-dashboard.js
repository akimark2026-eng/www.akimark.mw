...
// ===== NEW: FETCH TOTAL REVENUE FROM get-profit-api =====
async function fetchTotalRevenue() {
    try {
        const res = await fetch(`${SUPABASE_URL}/functions/v1/get-profit-api`, {
            method: 'GET',
        ...
        console.error('fetchTotalRevenue error:', e);
        return 0;
    }
}
...
async function renderDashboard(data) {
    ...
    // ===== FETCH TOTAL COMMISSIONS FROM get-profit-api =====
    const totalRevenue = await fetchTotalRevenue();
    document.getElementById('totalCommissions').textContent = Number(totalRevenue).toFixed(2);
...
async function loadData() {
    ...
    try {
        ...
        switch(currentSection) {
            case 'dashboard': await renderDashboard(data); break;
